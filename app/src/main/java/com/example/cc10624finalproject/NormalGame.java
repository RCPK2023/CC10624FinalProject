...
public class NormalGame extends AppCompatActivity {
    ...
    private Button cancelNormalGame;
    ...
    private void checkForGameCompletion() {
        ...
        if (matchedPairsCount == totalPairs) {
            ...
            int normalScore = calculateScore(elapsedTimeSeconds, mistakes);
    ...
    private void showAlertDialog(String message) {
        ...
        quitGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.dismiss();
                Intent intent = new Intent(NormalGame.this, Menu.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelNormalGame = (Button)findViewById(R.id.btn_NormalBack);
        ...
        imageButtons = new ImageButton[]{
                ...
                findViewById(R.id.imgbtn_n_13), findViewById(R.id.imgbtn_n_14)
        };

        // Create pairs of images
        pairs = new ArrayList<>(Arrays.asList(
                R.drawable.ic_anchor, R.drawable.ic_api, R.drawable.ic_brush, R.drawable.ic_bunny,
                R.drawable.ic_castle, R.drawable.ic_flower, R.drawable.ic_puzzle
        ));
        pairs.addAll(pairs);
        Collections.shuffle(pairs);
        ...
        cancelNormalGame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
